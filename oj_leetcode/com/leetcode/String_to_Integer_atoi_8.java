...
//		System.out.println(new Solution_String_to_Integer_atoi_8().myAtoi("-0012a21"));
//		
//		System.out.println(new Solution_String_to_Integer_atoi_8().myAtoi("2147483648"));
//		System.out.println(new Solution_String_to_Integer_atoi_8().myAtoi("10522545459"));
		
//		System.out.println(new Solution_String_to_Integer_atoi_8().myAtoi("-1123u3761867"));
//		System.out.println(new Solution_String_to_Integer_atoi_8().myAtoi("-1010023630o4"));
...
//		System.out.println(signal);
		...
		if(!(str.charAt(0)=='+' || str.charAt(0)=='-' )){
			...
			for(int i=1;i<str.length();i++){
//				System.out.println(str.charAt(i)+"  "+sum+"    "+(str.charAt(i)-'0'));
				if(!(str.charAt(i)>='0' && str.charAt(i)<='9')){
					break;
				}
				sum = (str.charAt(i)-'0')+sum*10;
